...
from baseline_cifar10_dvs.data import build_cifar10_dvs_loaders
from baseline_cifar10_dvs.hessian import _iter_with_limit, _load_checkpoint, _quantize_tensor_symmetric_per_tensor
from baseline_cifar10_dvs.metrics import (
    SpikeRateTracker,
    model_size_mb,
    parameter_count,
    sop_proxy,
...
from baseline_cifar10_dvs.model import build_model
from baseline_cifar10_dvs.unquant_runner import direct_encode, set_global_seed, write_epoch_metrics_csv
from baseline_cifar10_dvs.weight_state_mixed import estimate_state_cost_proxy
...
def run_difficulty_adaptive_state_precision_analysis(
    ...
    output_dir: str = "outputs/difficulty_adaptive_state_precision_cifar10_dvs",
    ...
    train_loader, test_loader = build_cifar10_dvs_loaders(cfg, device=device)
