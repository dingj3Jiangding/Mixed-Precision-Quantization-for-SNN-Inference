...
class VGG16CIFAR100SNN(nn.Module):
    """A VGG-16-like multi-step SNN for CIFAR-100."""
...
def build_model(num_classes: int = 100) -> VGG16CIFAR100SNN:
    return VGG16CIFAR100SNN(num_classes=num_classes)
