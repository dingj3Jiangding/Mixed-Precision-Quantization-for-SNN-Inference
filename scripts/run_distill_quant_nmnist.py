...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run Hessian-guided mixed-precision quantization with FP32-teacher "
            "logit distillation on baseline_nmnist."
        )
    )
    ...
    parser.add_argument("--output-dir", default="outputs/baseline_nmnist_distill_quant")
...
def main() -> None:
    ...
    from baseline_nmnist.distill_quant import run_distillation_quantization_analysis
    ...
    summary = run_distillation_quantization_analysis(
        cfg=cfg,
