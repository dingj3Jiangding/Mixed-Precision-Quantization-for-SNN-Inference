...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run state-write-aware quantization verification on baseline_vgg16."
    )
    ...
    parser.add_argument("--output-dir", default="outputs/state_write_aware_quantization_vgg16")
...
def main() -> None:
    ...
    from state_write_aware_quantization_vgg16.runner import run_state_write_aware_quantization_analysis
