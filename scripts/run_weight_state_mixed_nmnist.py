...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="outputs/baseline_nmnist_weight_state_mixed")
...
def main() -> None:
    ...
    from baseline_nmnist.weight_state_mixed import run_weight_state_mixed_analysis
