...
from baseline_full import BaselineFullConfig, run_uniform_quant_comparison
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run uniform weight quantization comparison for baseline_full."
    )
    ...
    parser.add_argument("--output-dir", default="outputs/baseline_full_uniform_quant")
