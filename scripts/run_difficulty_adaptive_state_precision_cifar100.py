...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run difficulty-adaptive state precision verification on CIFAR-100."
    )
    parser.add_argument("--checkpoint-path", default="outputs/baseline_cifar100/fp32_best.pt")
    parser.add_argument("--data-root", default="baseline_cifar100/data")
    parser.add_argument("--output-dir", default="outputs/difficulty_adaptive_state_precision_cifar100")
    ...
    parser.add_argument("--easy-threshold", type=float, default=0.9)
...
def main() -> None:
    ...
    from difficulty_adaptive_state_precision_cifar100.runner import (
