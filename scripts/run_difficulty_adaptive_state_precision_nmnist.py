...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run difficulty-adaptive state precision verification on baseline_nmnist."
    )
    ...
    parser.add_argument("--output-dir", default="outputs/difficulty_adaptive_state_precision_nmnist")
...
def main() -> None:
    ...
    from difficulty_adaptive_state_precision_nmnist.runner import (
