...
from baseline_nmnist import BaselineNMNISTConfig, run_uniform_quant_comparison
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run uniform weight quantization comparison for baseline_nmnist."
    )
    ...
    parser.add_argument("--output-dir", default="outputs/baseline_nmnist_uniform_quant")
