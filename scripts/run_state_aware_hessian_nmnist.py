...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run state-aware Hessian mixed-precision verification on baseline_nmnist "
    ...
    parser.add_argument("--output-dir", default="outputs/baseline_nmnist_state_aware_hessian")
...
def main() -> None:
    ...
    from baseline_nmnist.state_aware_hessian import run_state_aware_hessian_analysis
