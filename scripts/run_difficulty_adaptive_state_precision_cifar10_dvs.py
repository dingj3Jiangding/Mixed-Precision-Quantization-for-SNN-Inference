...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run difficulty-adaptive state precision verification on CIFAR10-DVS."
    )
    parser.add_argument("--checkpoint-path", default="outputs/baseline_cifar10_dvs/fp32_best.pt")
    parser.add_argument("--data-root", default="baseline_cifar10_dvs/data")
    parser.add_argument("--output-dir", default="outputs/difficulty_adaptive_state_precision_cifar10_dvs")
    parser.add_argument("--low-state-bits", type=int, default=7)
    ...
    parser.add_argument("--easy-threshold", type=float, default=0.98)
    ...
    parser.add_argument("--frame-split-by", choices=["number", "time"], default="number")
...
def main() -> None:
    ...
    from baseline_cifar10_dvs.config import BaselineCIFAR10DVSConfig
    from difficulty_adaptive_state_precision_cifar10_dvs.runner import (
        run_difficulty_adaptive_state_precision_analysis,
    )

    cfg = BaselineCIFAR10DVSConfig(
        ...
        frame_split_by=args.frame_split_by,
    )
