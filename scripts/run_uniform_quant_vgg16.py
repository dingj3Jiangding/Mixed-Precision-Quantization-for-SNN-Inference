...
from baseline_vgg16 import BaselineVGG16Config, run_uniform_quant_comparison
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run uniform weight quantization comparison for baseline_vgg16."
    )
    ...
    parser.add_argument("--output-dir", default="outputs/baseline_vgg16_uniform_quant")
