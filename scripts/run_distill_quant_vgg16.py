...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "logit distillation on baseline_vgg16."
        )
    )
    ...
    parser.add_argument("--output-dir", default="outputs/baseline_vgg16_distill_quant")
...
def main() -> None:
    ...
    from baseline_vgg16.distill_quant import run_distillation_quantization_analysis
