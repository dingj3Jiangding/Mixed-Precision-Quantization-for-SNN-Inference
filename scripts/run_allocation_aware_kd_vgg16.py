...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run allocation-aware KD on mixed-precision baseline_vgg16."
    )
    ...
    parser.add_argument("--output-dir", default="outputs/allocation_aware_kd_vgg16")
...
def main() -> None:
    ...
    from allocation_aware_kd_vgg16.runner import run_allocation_aware_distillation_analysis
