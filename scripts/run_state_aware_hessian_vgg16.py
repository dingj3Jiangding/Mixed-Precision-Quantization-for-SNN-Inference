...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run state-aware Hessian mixed-precision verification on baseline_vgg16 "
    ...
    parser.add_argument("--output-dir", default="outputs/baseline_vgg16_state_aware_hessian")
...
def main() -> None:
    ...
    from baseline_vgg16.state_aware_hessian import run_state_aware_hessian_analysis
