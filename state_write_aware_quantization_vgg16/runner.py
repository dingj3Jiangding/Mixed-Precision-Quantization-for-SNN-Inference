...
def run_state_write_aware_quantization_analysis(
    ...
    output_dir: str = "outputs/state_write_aware_quantization_vgg16",
    ...
    fp32_metrics = {
        ...
        "test_loss": 0.0,
        "spike_rate": 0.0,
        "avg_batch_infer_ms": 0.0,
        "write_ratio": 1.0,
        "estimated_state_write_bytes_per_sample": total_state_cost_proxy * 32.0 / 8.0,
    }
    # Evaluate FP32 with a no-op write-aware accounting path for consistent metrics.
