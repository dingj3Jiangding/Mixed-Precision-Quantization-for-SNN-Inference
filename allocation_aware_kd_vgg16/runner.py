...
from baseline_vgg16.hessian import (
...
from baseline_vgg16.metrics import parameter_count, sop_proxy, synapse_count_proxy
from baseline_vgg16.model import build_model
from baseline_vgg16.quantization import clone_and_quantize_model_weights, parse_bits_list
from baseline_vgg16.unquant_runner import direct_encode, evaluate, set_global_seed, write_epoch_metrics_csv
from baseline_vgg16.weight_state_mixed import load_weight_allocation_rows
...
def finetune_with_allocation_aware_distillation(
    ...
    if feature_distill_beta < 0.0:
        raise ValueError("feature_distill_beta must be >= 0.")
...
def run_allocation_aware_distillation_analysis(
    ...
    output_dir: str = "outputs/allocation_aware_kd_vgg16",
    ...
    layer_severity = _build_layer_severity(
        layer_rows=layer_rows,
        layer_bits=layer_bits,
        bits_sorted=bits_sorted,
